                                                                ...
                                                                <tr style="margin:0;padding:0">
                                                                    <td
                                                                        ...
                                                                        Chúc mừng bạn<strong
                                                                            style="margin:0;padding:0;font-size:16px;font-weight:bold"></strong>. Bạn đã đặt hàng thành công
                                                                    </td>
                                                                </tr>
                                                                <tr style="margin:0;padding:0">
                                                                    <td style="height:8px;margin:0;padding:0;font-size:0;line-height:0">
                                                                ...
                                                                <tr style="margin:0;padding:0">
                                                                    <td
                                                                        ...
                                                                        <div style="text-align:center"> <a
                                                                            ...
                                                                            <a href="{{route('checkout.lich_su_mua_hang')}}" class="m_5519974867742442351link_button" style="text-decoration: none; padding: 20px; background: #efebdb;;
