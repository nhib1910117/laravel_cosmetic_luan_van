...
@section('content')
    <div class="title-left">
        <h2>{{isset($tags_edit) ? "Chỉnh sửa Thẻ" : "Tạo mới Thẻ"}}</h2>
    </div>
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
            ...
            <div class="x_content">
                ...
                <form action="{{isset($tags_edit) ? route('tags.update',$tags_edit->id) : route('tags.store')}}"  method="POST" class="form-label-left input_mask" enctype="multipart/form-data">
                    <div class="col-md-12 col-sm-12  form-group">
                        <input type="text" class="form-control" value="{{isset($tags_edit) ? $tags_edit->name : old('name') }}" name="name" id="inputSuccess2" placeholder="Tên Thẻ">
                        @if($errors->has('name'))
