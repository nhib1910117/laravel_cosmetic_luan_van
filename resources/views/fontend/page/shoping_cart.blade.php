        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="shoping__cart__btns">
                    <a  style="background: #408e52;" href="{{route('home.all_product')}}" class="text-white primary-btn cart-btn "><i class="fa fa-undo" aria-hidden="true"></i> CONTINUE SHOPPING</a>
                </div>
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                <div class="shoping__checkout">
                    ...
                    @else
                    <button class="primary-btn" data-toggle="modal" data-target="#notice_quantity_cart">PROCEED TO CHECKOUT</button>
                    @endif
                </div>
            </div>
        </div>
